...
async def start(_, msg):
    buttons = [
        ...
        [
          InlineKeyboardButton("𝗛𝗘𝗟𝗣", url="https://t.me/Heroku_Cc_Binsss"),
          InlineKeyboardButton("𝗢𝗪𝗡𝗘𝗥", url="https://t.me/hum_apke_hai_kon7"),
          ],
               [
                InlineKeyboardButton("𝗟𝗜𝗩𝗘 𝗖𝗖", url="https://t.me/Heroku_Cc_Binsss"),

],
[
              InlineKeyboardButton("𝗕𝗔𝗡 𝗔𝗟𝗟︎", url=f"https://github.com/naaz67/DAXXMUSIC"),
              InlineKeyboardButton("︎𝗠𝗨𝗦𝗜𝗖", url=f"https://github.com/DAXXTEAM/DAXXMUSIC"),
              ],
              [
              InlineKeyboardButton("𝗠𝗔𝗡𝗔𝗚𝗘𝗠𝗘𝗡𝗧︎", url=f"https://github.com/naaz67/DAXXMUSIC"),
InlineKeyboardButton("𝗖𝗛𝗔𝗧 𝗕𝗢𝗧", url=f"httphttps://github.com/naaz67/DAXXMUSIC"),
],
[
...
[
InlineKeyboardButton("𝗨𝗦𝗘𝗥𝗕𝗢𝗧", url=f"https://github.com/naaz67/DAXXMUSIC"),
InlineKeyboardButton("𝗦𝗘𝗔𝗥𝗖𝗛𝗕𝗢𝗧", url=f"https://github.com/naaz67/DAXXMUSIC"),
],
[
InlineKeyboardButton("𝗖𝗖 𝗕𝗢𝗧", url=f"https://github.com/DAXXTEAM/CC_BOT"),
    ...
    await msg.reply_photo(
        photo="https://graph.org/file/510dcc2c9419427583754.jpg",
        caption=start_txt,
